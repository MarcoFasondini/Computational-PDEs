...
\]
This is an example of a \textbf{finite difference} approximation to a derivative of a function.  This particular approximation is known as a \emph{forward difference} approximation (or formula). 
\newpage 
 Replacing $h$ with $-h$, we obtain a \emph{backward difference} formula

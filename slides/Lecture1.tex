...
\includegraphics[width=\linewidth]{jl_bEvb5O/Lecture1_1_1.pdf}
...
\begin{lstlisting}
1.320367 seconds (505.90 k allocations: 1.028 GiB, 33.65(*@{{\%}}@*) gc time, 16.33(*@{{\%}}@*)
 compilation time)
\end{lstlisting}

\includegraphics[width=\linewidth]{jl_bEvb5O/Lecture1_3_1.pdf}
...
\includegraphics[width=\linewidth]{jl_bEvb5O/Lecture1_4_1.pdf}
